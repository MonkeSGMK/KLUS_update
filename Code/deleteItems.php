...
// Check if the "voldoende" option was selected in the cards
if (isset($_POST['voldoende'])) {
    // Perform the necessary database update or any other actions here
    // For example, update the database based on the selected option
    $selectedOption = $_POST['voldoende'];
    // Add your database update logic here
}

// Rest of your PHP code for fetching and processing data
if ($_GET['type'] == 'materialen') {
    $type = 'materiaal';
} elseif ($_GET['type'] == 'greedschap') {
    $type = 'greedschap';
}
$stmt = $conn->prepare('SELECT id, naam, aantal, image_path FROM ' . $type . '');
$stmt->execute();
...
<body>
    ...
    <header>
        ...
        <div class="nav-links">
            <a href="editIndex.php"><img src="assets/other/admin.png" width="25px"></a>
    ...
    <div class="top-box">
        <div class="Filter">
            ...
            <div id="filterdropdown" class="dropdown-content">
                ...
                <a href="#" onclick="filterCards(1); myFunction()">Op</a>
                <a href="#" onclick="filterCards(2); myFunction()">Bijna op</a>
                <a href="#" onclick="filterCards(3); myFunction()">Voldoende</a>
                <a href="#" onclick="filterCards('alles');  myFunction()">Alles</a>
            </div>
        </div>
        ...
        <div class="sort">
            ...
            <ul id="sortDrowndown" class="dropdown-content">
                <a onclick="sorting('alphabetically'); ourFunction()">alfabetisch</a>
    ...
    <div class="container-fluid mt-4">
        <div class="row" id='itemsToSort'>
            ...
            if (isset($_POST['search'])) {
                ...
                $stmt = $conn->prepare('SELECT id, naam, aantal, image_path FROM ' . $type . ' WHERE naam LIKE ?');
            ...
            foreach ($result as $data) {
                ...
                echo '<a href="delete.php?type=' . $type . '&id=' . $data['id'] . '">';
                echo '<p class="card-text" style="text-decoration: underline;"><img src="assets/other/op.png" width="20" style="margin-right: 20px;">Verwijder</p>';
                echo '</a>';
                echo '</div></div></div>';
            }
            ?>
